...
if __name__ == "__main__":
    ...
    ox.save_graph_geopackage(G_combined, multimodal_dir / "melbourne_multimodal_test.gpkg")
    ...
    ox.save_graph_geopackage(G_combined_connected, multimodal_dir / "melbourne_multimodal_connected_test.gpkg")
